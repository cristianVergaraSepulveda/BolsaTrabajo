...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Enterprise.approved'
        db.delete_column('bolsa_trabajo_enterprise', 'approved')

        # Adding field 'UserProfile.approved'
        db.add_column('bolsa_trabajo_userprofile', 'approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Student.approved'
        db.delete_column('bolsa_trabajo_student', 'approved')


    def backwards(self, orm):
        
        # Adding field 'Enterprise.approved'
        db.add_column('bolsa_trabajo_enterprise', 'approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'UserProfile.approved'
        db.delete_column('bolsa_trabajo_userprofile', 'approved')

        # Adding field 'Student.approved'
        db.add_column('bolsa_trabajo_student', 'approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
