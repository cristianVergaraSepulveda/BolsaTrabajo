...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentLevel.ordering'
        db.add_column('bolsa_trabajo_studentlevel', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'StudentLevel.ordering'
        db.delete_column('bolsa_trabajo_studentlevel', 'ordering')
