...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Postulation'
        db.create_table('bolsa_trabajo_postulation', (
        ...
        db.send_create_signal('bolsa_trabajo', ['Postulation'])


    def backwards(self, orm):
        
        # Deleting model 'Postulation'
        db.delete_table('bolsa_trabajo_postulation')
