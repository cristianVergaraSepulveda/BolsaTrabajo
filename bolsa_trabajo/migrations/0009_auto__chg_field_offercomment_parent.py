...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OfferComment.parent'
        db.alter_column('bolsa_trabajo_offercomment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bolsa_trabajo.OfferComment'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'OfferComment.parent'
        db.alter_column('bolsa_trabajo_offercomment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bolsa_trabajo.OfferComment'], null=True))
