...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OfferComment.Offer'
        db.delete_column('bolsa_trabajo_offercomment', 'Offer_id')

        # Adding field 'OfferComment.offer'
        db.add_column('bolsa_trabajo_offercomment', 'offer', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['bolsa_trabajo.Offer']), keep_default=False)
