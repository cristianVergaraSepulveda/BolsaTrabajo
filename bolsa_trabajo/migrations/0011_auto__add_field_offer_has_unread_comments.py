...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Offer.has_unread_comments'
        db.add_column('bolsa_trabajo_offer', 'has_unread_comments', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Offer.has_unread_comments'
        db.delete_column('bolsa_trabajo_offer', 'has_unread_comments')
