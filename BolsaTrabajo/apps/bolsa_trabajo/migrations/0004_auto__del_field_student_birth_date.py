...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('bolsa_trabajo_student', 'birth_date')
    
    
    def backwards(self, orm):
        
        # Adding field 'Student.birth_date'
        db.add_column('bolsa_trabajo_student', 'birth_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 11, 28)), keep_default=False)
