...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WorkRegistry'
        db.create_table('bolsa_trabajo_workregistry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('postulation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bolsa_trabajo.Postulation'])),
        ))
        db.send_create_signal('bolsa_trabajo', ['WorkRegistry'])


    def backwards(self, orm):
        
        # Deleting model 'WorkRegistry'
        db.delete_table('bolsa_trabajo_workregistry')
    ...
    models = {
        ...
        'bolsa_trabajo.offer': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 26)'}),
