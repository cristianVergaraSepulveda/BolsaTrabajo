...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OfferLevel.minimum_salary'
        db.add_column('bolsa_trabajo_offerlevel', 'minimum_salary', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OfferLevel.minimum_salary'
        db.delete_column('bolsa_trabajo_offerlevel', 'minimum_salary')
