...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Offer.end_date'
        db.add_column('bolsa_trabajo_offer', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 11, 4)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Offer.end_date'
        db.delete_column('bolsa_trabajo_offer', 'end_date')
