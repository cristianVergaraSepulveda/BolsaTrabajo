...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OfferComment.new_replies'
        db.delete_column('bolsa_trabajo_offercomment', 'new_replies')

        # Adding field 'OfferComment.has_replies'
        db.add_column('bolsa_trabajo_offercomment', 'has_replies', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'OfferComment.new_replies'
        db.add_column('bolsa_trabajo_offercomment', 'new_replies', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'OfferComment.has_replies'
        db.delete_column('bolsa_trabajo_offercomment', 'has_replies')
