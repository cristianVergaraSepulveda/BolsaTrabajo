...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.validated_email'
        db.add_column('bolsa_trabajo_userprofile', 'validated_email', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'UserProfile.validated_email'
        db.delete_column('bolsa_trabajo_userprofile', 'validated_email')
