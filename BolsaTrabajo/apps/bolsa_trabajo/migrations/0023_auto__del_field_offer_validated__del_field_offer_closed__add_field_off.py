...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Offer.validated'
        db.delete_column('bolsa_trabajo_offer', 'validated')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Offer.validated'
        db.add_column('bolsa_trabajo_offer', 'validated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Offer.closed'
        db.add_column('bolsa_trabajo_offer', 'closed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
