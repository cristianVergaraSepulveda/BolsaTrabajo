...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offer.status'
        db.alter_column('bolsa_trabajo_offer', 'status', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Offer.status'
        db.alter_column('bolsa_trabajo_offer', 'status', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
