...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EnterpriseComment.has_replies'
        db.add_column('bolsa_trabajo_enterprisecomment', 'has_replies', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Enterprise.has_unread_comments'
        db.add_column('bolsa_trabajo_enterprise', 'has_unread_comments', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EnterpriseComment.has_replies'
        db.delete_column('bolsa_trabajo_enterprisecomment', 'has_replies')

        # Deleting field 'Enterprise.has_unread_comments'
        db.delete_column('bolsa_trabajo_enterprise', 'has_unread_comments')
