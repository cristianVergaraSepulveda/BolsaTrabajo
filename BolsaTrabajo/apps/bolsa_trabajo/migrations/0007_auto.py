...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tags on 'Student'
        db.create_table('bolsa_trabajo_student_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('student', models.ForeignKey(orm['bolsa_trabajo.student'], null=False)),
            ('tag', models.ForeignKey(orm['bolsa_trabajo.tag'], null=False))
        ))
        db.create_unique('bolsa_trabajo_student_tags', ['student_id', 'tag_id'])
    
    
    def backwards(self, orm):
        
        # Removing M2M table for field tags on 'Student'
        db.delete_table('bolsa_trabajo_student_tags')
