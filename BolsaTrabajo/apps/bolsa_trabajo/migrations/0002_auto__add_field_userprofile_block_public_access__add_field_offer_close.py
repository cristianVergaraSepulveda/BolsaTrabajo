...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.block_public_access'
        db.add_column('bolsa_trabajo_userprofile', 'block_public_access', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Offer.closed'
        db.add_column('bolsa_trabajo_offer', 'closed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Offer.available_slots'
        db.add_column('bolsa_trabajo_offer', 'available_slots', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Student.has_cv'
        db.add_column('bolsa_trabajo_student', 'has_cv', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Student.resume'
        db.add_column('bolsa_trabajo_student', 'resume', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Contract.end_date'
        db.add_column('bolsa_trabajo_contract', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 11, 27)), keep_default=False)

        # Adding field 'Contract.start_date'
        db.add_column('bolsa_trabajo_contract', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 11, 27)), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'UserProfile.block_public_access'
        db.delete_column('bolsa_trabajo_userprofile', 'block_public_access')

        # Deleting field 'Offer.closed'
        db.delete_column('bolsa_trabajo_offer', 'closed')

        # Deleting field 'Offer.available_slots'
        db.delete_column('bolsa_trabajo_offer', 'available_slots')

        # Deleting field 'Student.has_cv'
        db.delete_column('bolsa_trabajo_student', 'has_cv')

        # Deleting field 'Student.resume'
        db.delete_column('bolsa_trabajo_student', 'resume')

        # Deleting field 'Contract.end_date'
        db.delete_column('bolsa_trabajo_contract', 'end_date')

        # Deleting field 'Contract.start_date'
        db.delete_column('bolsa_trabajo_contract', 'start_date')
