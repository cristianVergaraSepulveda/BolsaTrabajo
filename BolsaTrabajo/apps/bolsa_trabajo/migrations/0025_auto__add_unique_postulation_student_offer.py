...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Postulation', fields ['student', 'offer']
        db.create_unique('bolsa_trabajo_postulation', ['student_id', 'offer_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Postulation', fields ['student', 'offer']
        db.delete_unique('bolsa_trabajo_postulation', ['student_id', 'offer_id'])
